...
class PagosControllerTest < ActionController::TestCase
  ...
  test "should create pago" do
    assert_difference('Pago.count') do
      post :create, pago: { cantLab: @pago.cantLab, farmacia_id: @pago.farmacia_id, monto: @pago.monto, numcomprobante: @pago.numcomprobante }
    end
  ...
  test "should update pago" do
    patch :update, id: @pago, pago: { cantLab: @pago.cantLab, farmacia_id: @pago.farmacia_id, monto: @pago.monto, numcomprobante: @pago.numcomprobante }
    assert_redirected_to pago_path(assigns(:pago))
  end
