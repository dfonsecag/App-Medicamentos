...
class TipoPlansControllerTest < ActionController::TestCase
  ...
  test "should create tipo_plan" do
    assert_difference('TipoPlan.count') do
      post :create, tipo_plan: { descripcion: @tipo_plan.descripcion, plan_paciente_id: @tipo_plan.plan_paciente_id, tipo: @tipo_plan.tipo }
    end
  ...
  test "should update tipo_plan" do
    patch :update, id: @tipo_plan, tipo_plan: { descripcion: @tipo_plan.descripcion, plan_paciente_id: @tipo_plan.plan_paciente_id, tipo: @tipo_plan.tipo }
    assert_redirected_to tipo_plan_path(assigns(:tipo_plan))
  end
